...
# \\samba.idi.ntnu.no\chrischa\Github\TDT4255\xps\system\system.mhs
# The software specification of the system is in file :
# \\samba.idi.ntnu.no\chrischa\Github\TDT4255\xps\system\system.mss
...
rwMips_program: $(CYG_RWMIPS_OUTPUT) 

$(CYG_RWMIPS_OUTPUT) : $(RWMIPS_SOURCES) $(RWMIPS_HEADERS) $(RWMIPS_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/rwmips_compiler.opt
	@mkdir -p $(RWMIPS_OUTPUT_DIR) 
	$(RWMIPS_CC) $(RWMIPS_CC_OPT) $(RWMIPS_SOURCES) -o $(CYG_RWMIPS_OUTPUT) \
	$(RWMIPS_OTHER_CC_FLAGS) $(RWMIPS_INCLUDES) $(RWMIPS_LIBPATH) \
	$(RWMIPS_CFLAGS) $(RWMIPS_LFLAGS) 
	$(RWMIPS_CC_SIZE) $(CYG_RWMIPS_OUTPUT) 
	@echo ""
