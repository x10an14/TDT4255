...
# Project:\\samba.idi.ntnu.no\chrischa\Github\TDT4255\xps\system\system.xmp
#
...
RWMIPS_OUTPUT_DIR = rwMips
RWMIPS_OUTPUT = $(RWMIPS_OUTPUT_DIR)/executable.elf
CYG_RWMIPS_OUTPUT_DIR = rwMips
CYG_RWMIPS_OUTPUT = $(CYG_RWMIPS_OUTPUT_DIR)/executable.elf
...
BRAMINIT_ELF_FILES =  $(CYG_RWMIPS_OUTPUT) 
BRAMINIT_ELF_FILE_ARGS =   -pe microblaze_0 $(RWMIPS_OUTPUT) 

ALL_USER_ELF_FILES = $(CYG_TESTAPP_MEMORY_MICROBLAZE_0_OUTPUT) $(CYG_TESTAPP_PERIPHERAL_MICROBLAZE_0_OUTPUT) $(CYG_RWMIPS_OUTPUT) 
...
SIMGEN_OPTIONS = -p $(DEVICE) -lang $(LANGUAGE) $(SEARCHPATHOPT) $(BRAMINIT_ELF_FILE_ARGS) $(MIX_LANG_SIM_OPT) -msg __xps/ise/xmsgprops.lst -s mti -X M:/Github/TDT4255/xps/system/
...
PROGRAMCLEAN_TARGETS = TestApp_Memory_microblaze_0_programclean TestApp_Peripheral_microblaze_0_programclean rwMips_programclean 
...
#################################################################
# SOFTWARE APPLICATION RWMIPS
#################################################################

RWMIPS_SOURCES = drivers/mips_v1_00_a/src/mips.c rwMips/src/rwMain.c 

RWMIPS_HEADERS = rwMips/src/mips.h 

RWMIPS_CC = mb-gcc
RWMIPS_CC_SIZE = mb-size
RWMIPS_CC_OPT = -O2
RWMIPS_CFLAGS = 
RWMIPS_CC_SEARCH = # -B
RWMIPS_LIBPATH = -L./microblaze_0/lib/ # -L
RWMIPS_INCLUDES = -I./microblaze_0/include/  -IrwMips/src/ # -I
RWMIPS_LFLAGS = # -l
RWMIPS_LINKER_SCRIPT = rwMips/rwMips_linker_script.ld
RWMIPS_LINKER_SCRIPT_FLAG = -T $(RWMIPS_LINKER_SCRIPT) 
RWMIPS_CC_DEBUG_FLAG =  -g 
RWMIPS_CC_PROFILE_FLAG = # -pg
RWMIPS_CC_GLOBPTR_FLAG= # -mxl-gp-opt
RWMIPS_MODE = executable
RWMIPS_LIBG_OPT = -$(RWMIPS_MODE) microblaze_0
RWMIPS_CC_INFERRED_FLAGS= -mno-xl-soft-mul -mxl-barrel-shift -mxl-pattern-compare -mcpu=v8.00.b 
RWMIPS_CC_START_ADDR_FLAG=  #  # -Wl,-defsym -Wl,_TEXT_START_ADDR=
RWMIPS_CC_STACK_SIZE_FLAG=  #  # -Wl,-defsym -Wl,_STACK_SIZE=
RWMIPS_CC_HEAP_SIZE_FLAG=  #  # -Wl,-defsym -Wl,_HEAP_SIZE=
RWMIPS_OTHER_CC_FLAGS= $(RWMIPS_CC_GLOBPTR_FLAG)  \
                  $(RWMIPS_CC_START_ADDR_FLAG) $(RWMIPS_CC_STACK_SIZE_FLAG) $(RWMIPS_CC_HEAP_SIZE_FLAG)  \
                  $(RWMIPS_CC_INFERRED_FLAGS)  \
                  $(RWMIPS_LINKER_SCRIPT_FLAG) $(RWMIPS_CC_DEBUG_FLAG) $(RWMIPS_CC_PROFILE_FLAG) 
