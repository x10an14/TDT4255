/*****************************************************************************
* Filename:          M:\Github\TDT4255\xps\system/drivers/mips_v1_00_a/src/mips_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the mips driver
* Date:              Mon Oct 07 22:09:14 2013 (by Create and Import Peripheral Wizard)
*****************************************************************************/
...
XStatus MIPS_SelfTest(void * baseaddr_p)
{
  ...
  MIPS_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = MIPS_mReadSlaveReg0(baseaddr, 0);
  ...
  MIPS_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = MIPS_mReadSlaveReg1(baseaddr, 0);
  ...
  MIPS_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = MIPS_mReadSlaveReg2(baseaddr, 0);
  ...
  MIPS_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = MIPS_mReadSlaveReg3(baseaddr, 0);
  ...
  MIPS_mWriteSlaveReg4(baseaddr, 0, 5);
  Reg32Value = MIPS_mReadSlaveReg4(baseaddr, 0);
